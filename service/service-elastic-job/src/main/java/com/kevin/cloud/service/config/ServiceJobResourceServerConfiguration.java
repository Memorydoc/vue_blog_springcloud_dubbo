...
public class ServiceJobResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/blog/front/**").permitAll() // 不拦截前端请求
                .antMatchers("/job/**").hasAuthority("USER");
    }
