 ...
 * @description:
 * @author: kevin
 * @create: 2020-01-23 12:43
 **/
@Component
public class IdProviderGenerator {


    private Logger log = LoggerFactory.getLogger(IdProviderGenerator.class);
    ...
    public synchronized long nextLid() {
